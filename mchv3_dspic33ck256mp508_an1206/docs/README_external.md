...
<p style='text-align: justify;'>
6. Close the top cover of the enclosure and secure it with screws.</p>
<p style='text-align: justify;'>
7. Power Cord Connection. Make sure the power cord is disconnected from the AC mains before connecting the female terminal of the power cable to the AC input connector J1 of the Development Board.</p>
<p align="center">
...
<p style='text-align: justify;'>
4. Open userparams.h (under acim.X -> headerfiles) in the project acim.X and ensure INTERNAL_OPAMP_CONFIGPIM is undefined as this demonstration is for External Op-Amp configuration.</p>
  <p align="center">
...
<p style='text-align: justify;'>The following table summarizes device pins configured and used in the AN1292 motor control application firmware demonstrated using the Development Board and the dsPIC33CK256MP508 External Op-Amp Motor Control PIM(MA330041-1). Refer “dsPIC33CK256MP508 External Op-Amp Motor Control Plug-in-Module (PIM) Information Sheet (DS50002756)” for more information.</p>
 ...
 <p align="center">
  <img  src="../../images/pinconfigurationtable.PNG"></p>
...
4. dsPIC33CK256MP508 External Op-Amp Motor Control Plug-in-Module (PIM) Information Sheet (DS50002757)
